      ...
      <div className="w-full ">
        ...
        >
          ...
          <div className={`w-full md:w-80 h-10 flex justify-center relative ${isMobileMenuOpen ? 'block' : 'hidden md:block'}`}>
            ...
            <input
              type="text"
              className="bg-neutral-300 text-neutral-700 w-full h-10 rounded outline-none pl-8"
              placeholder={"Search..."}
              value={searchValue}
              onChange={(e) => {
        ...
        {/* Navigation menu */}
        <div className={`w-full bg-neutral-700 text-neutral-200 p-2 m-auto ${isMobileMenuOpen ? 'block' : 'hidden md:block'}`}>
