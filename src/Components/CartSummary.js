        ...
        <div className="bg-white rounded-3xl border border-gray-200/70 p-6 shadow-sm hover:shadow-md transition duration-200 sticky top-8">
            ...
            <div className="space-y-4 mb-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <span className="font-semibold text-gray-900">{Math.floor(tax).toLocaleString()}</span>
                </div>
                <div className="border-t border-gray-200 pt-4">
                    <div className="flex items-center justify-between">
                        <span className="text-lg font-medium text-gray-900">Total</span>
                        <span className="text-2xl font-semibold text-gray-900">{Math.floor(total + tax).toLocaleString()}</span>
                    </div>
                </div>
            </div>
