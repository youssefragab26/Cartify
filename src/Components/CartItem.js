...
export default function CartItem({productImage , productName , productPrice , productStorage , productColor, index}) {
      ...
      <div className="flex items-center p-5 md:p-6">
        ...
        <div className="flex flex-col items-end space-y-4">
          ...
          <button 
            ...
            className="text-gray-500 cursor-pointer hover:text-red-500 text-sm font-medium transition-colors duration-200 flex items-center space-x-2 group/remove"
          >
